                            ...
                            <tbody>
                                <tr v-for="row in tableStyles" :key="row.id">
                                    ...
                                    <td>
                                        ...
                                        <div v-if="row.label">
                                            <b-badge
                                                :variant="row.label.colorClass"
                                                >{{ row.label.text }}</b-badge
                                            >
                                        </div>
                                    </td>
                                    <td>
        ...
        <b-row>
            ...
            <b-col lg="6">
                ...
                >
                    ...
                    <p>
                        Each row is highlighted. You will never lost there.
                        That&apos;s how all of us learned in school the table
                ...
                >
                    ...
                    <p>
                        Add any non-bordered .table within a widget for a
                        seamless design. Awesome look for no cost. Just wrap the
                        table with simple css class
